...
class ICNet():
    ...
    def __init__(self, width, height, n_classes, weight_path=None, training=False, input_depth=3):
        ...
        self.model = self.build_bn(width=self.width, height=self.height, n_classes=self.n_classes, train=training, input_depth=input_depth)
    ...
    def build_bn(self, width, height, n_classes, weights_path=None, train=False, input_depth=3):

        inp = Input(shape=(height, width, input_depth))
